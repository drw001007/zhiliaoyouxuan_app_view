		...
		<view class="ordview">
			...
			<view class="ordvul">
				<view class="dli" v-for="(item,oIndex) in orderList" :key="oIndex" >
					...
					<view class="dli_two">
						<view class="dli_twoops" v-for='(it,lIndex) in item.goods_list' :key="lIndex">
							<view class="ord_tu">
								<image :src="it.original_img" mode="aspectFit"></image>
							</view>
							<view class="ord-righ">
								<view class="ord_name">{{it.goods_name}}</view>
								<view class="ord_time"> {{it.shop_price}}  <text>X{{it.goods_num}}</text></view> 
								<!-- <view class="ord_time"></view> -->
							</view> 
						</view>
					</view>
...
<style>
	...
	.ordview .ordvul .dli .dli_two{width: 94%;padding:15upx 3%;}
	.ordview .ordvul .dli .dli_two .dli_twoops{display: flex;}
	...
	.ordview .ordvul .dli .dli_two .ord-righ .ord_time{color:#f33;font-size:26upx;margin-top:15upx;}
	.ord_time text{margin-left: 20upx;color:#999;font-size:24upx;}
