		...
		if (this.type == 'transparentFixed') {
			...
			window.onscroll = function(e) {
				...
				if (scrollTop > 150) {
					...
					_this.transparentValue = scrollTop / 150;
				}
			};
			// #endif
		}
...
<style lang="scss" scoped>
	.hesearchbox{width:94%;padding:20upx 3%;height: 60upx;background:#fff; position:relative;top:0;z-index:99; background:#fff; }
	.hesearchbox .searview{width: 670upx;height: 60upx;margin:0 auto; background: #eeeeee;  	border-radius: 10upx;}
	.hesearchbox .searview icon{ 	margin-left: 10upx;	float: left;margin-top:10upx;}
	...
	.hesearchbox .setaxt{font-size:24upx;height: 60upx;line-height: 60upx;color:#999999;display: flex;margin-left:20upx;float: left;}
	.hesearchbox .setaxt view{color:#333;}
	.hesearchbox .searview .middsear{float: right;width: 110upx;color: #fff;background:linear-gradient(to right,#e74766,#fe3435) ;text-align: center;line-height: 60upx;border-top-right-radius: 10upx;border-bottom-right-radius: 10upx;letter-spacing:4upx;font-size:30upx;}
